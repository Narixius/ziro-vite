...
The Ziro package has been successfully published to the npm registry, with the latest version being \cc{0.0.16}\footnote{\url{https://www.npmjs.com/package/ziro}} as of now. The package is actively being developed and will likely see future releases with additional features and improvements.
