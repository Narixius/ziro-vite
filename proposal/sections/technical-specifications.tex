...
When the \cc{router.handleRequest(request)} method is called, the router follows a systematic process to find and handle the appropriate route. Here is how the process works:
