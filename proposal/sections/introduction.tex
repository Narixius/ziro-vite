...
\begin{itemize}
	\item \cc{ziro/router}: Contains the core routing concepts, designed to work independently of any specific framework.

	\item \cc{ziro/generator}: A tool for generating TypeScript type-safe definitions to ensure robust developer workflows.

	\item \cc{ziro/react}: A React-compatible implementation for seamless integration with React-based projects.
\end{itemize}
